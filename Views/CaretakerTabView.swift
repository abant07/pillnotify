...
// This is the tab view that is navigated to when a user creates a new caretaker account or signs into a caretaker account
// Disadvantages are cannot navigate to another screen after navigating here, because its in a Zstack rather a navgationstack
    ...
    var body: some View {
        if networkMonitor.isConnected
        {
            ZStack {
                ...
                VStack {
                    Spacer()
                    CustomTabBar(selectedTab: $tabSelected) // custom tab bar
                }
            }
            ...
            .toolbar {
                ToolbarItem(placement: .navigationBarLeading)
                {
                    ...
                    }, label: {Label("Logout", systemImage: "person.crop.circle.fill")})
