...
// This struct shows the tab view when the user opens the app after logging in
// This makes it so they dont need to login everytime
struct StartSeniorTab: View {
